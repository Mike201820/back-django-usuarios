# Generated by Django 4.2.13 on 2024-06-15 15:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jobs.empresa')),
                ('postulantes', models.ManyToManyField(blank=True, related_name='ofertas', to='jobs.postulante')),
            ],
        ),
    ]
